"""
PixelMind LLM Pretraining
=========================
Stage 1: Train a 64M Transformer from scratch with next-token prediction.

Usage:
    python -m pixelmind.trainer.llm_pretrain --data_path ../data/text/pretrain.jsonl

Recommended: lr=5e-4, epochs=2, batch=32, max_seq=340
"""
...
from ..data.text_dataset import PretrainDataset
...
def main():
    parser = argparse.ArgumentParser(description="PixelMind LLM Pretraining")
    parser.add_argument("--save_dir", type=str, default="./out", help="output dir")
    parser.add_argument("--save_weight", default="pretrain", type=str, help="weight prefix")
    ...
    parser.add_argument("--max_seq_len", default=340, type=int, help="max sequence length")
    parser.add_argument("--data_path", type=str, default="../data/text/pretrain.jsonl", help="data path")
    parser.add_argument("--from_weight", default="none", type=str, help="base weight (none=from scratch)")
    ...
    parser.add_argument("--wandb_project", type=str, default="PixelMind-Pretrain")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb.init(
            ...
            name=f"PixelMind-Pretrain-E{args.epochs}-B{args.batch_size}-LR{args.learning_rate}",
            id=wandb_id,
            resume=resume,
        )
